...
#Retrieving data
movie_data <- read.csv("C:/Users/My PC/Desktop/New folder/IMDB-Dataset/movies.csv", stringsAsFactors = FALSE)
rating_data <- read.csv("C:/Users/My PC/Desktop/New folder/IMDB-Dataset/ratings.csv")
...
ratingMatrix <- reshape2::dcast(rating_data, userId~movieId, value.var = "rating", na.rm=FALSE) #basically our sparse matrix
